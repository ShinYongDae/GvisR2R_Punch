...
void CEngrave::SetDispDualSample()
{
	if (!pDoc)
		return;
...
void CEngrave::SetDispSingleSample()
{
	if (!pDoc)
		return;
...
void CEngrave::SetDispSingleTest()
{
	if (!pDoc)
		return;
